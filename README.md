...
| | Document | What it is |
|---|---|---|
| **Lesson 01** | [You Are Not a Judge](lessons/0001-you-are-not-a-judge.html) | What an evaluation actually is: the feedback-versus-advice distinction, the three ingredients, and the two failure modes. 5 drills. |
...
Lessons 02–09 are planned. The roadmap is on the [course home page](index.html).
